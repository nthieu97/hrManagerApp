...
export class EmployeesComponent implements OnInit {
  ...
  data: any[] = [
    ...
    {
      id: 4,
      name: 'Nguyễn Minh Hảo',
      username: 'haonm324432',
      position: 'nhân viên',
      department: 'developer',
      image:
    ...
    },
    {
      ...
      username: 'minhhi3837429',
      position: 'nhân viên',
      department: 'developer',
      image:
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQrcoVWwToWDr28a9mJac2I7teahpSSy6T-RA&usqp=CAU',
    },
    {
      id: 8,
      name: 'Trần Ông Bắc',
      ...
      department: 'BA',
      image:
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSx_P94YMOoF7xKLwhN5QtDeDB8Fpmg6WihpQ&usqp=CAU',
    },
  ];
  employees: any = [];
